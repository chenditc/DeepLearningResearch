...
def load_security(security = 'all', startDate = '1970-01-01', stopDate = '2070-01-01', days = 5, threshold = 5):
    ...
    normalDates = getImportantDates(security = security, minDate = startDate, maxDate = stopDate, threshold = 0)
    normalDates = normalDates[:len(importantDates)]
    importantDates = list(importantDates) + list(normalDates)
    stockData = []
